...
#                           token='6F3150115E6598C6D309F3C47EFB26A2',
#                           secret='rEJU82Z2QEozmbeWMAm7uft0fHDP1+HuVRvU/iEs')
...
ui <- fluidPage(
  ...
  tags$style(HTML("
    body {
      background-image: url('https://raw.githubusercontent.com/IDBach16/Moeller_2024/main/2024%20Moeller%20Projects/IMG_1995.jpg');
  ...
  ")),
  titlePanel("Moeller Pitcher Analysis"),
  navbarPage(
    ...
    tabPanel("Moeller Pitcher Success Visualization",
...
server <- function(input, output, session) {
  ...
  df <- read_csv("Moeller_2024_Final_Season.csv")
